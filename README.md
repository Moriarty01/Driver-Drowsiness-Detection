...
### Step 2: 
Download the file Make sure you download it in the same folder. 
...
## Results: 
The GUI has been created using basic HTML & CSS  and we have used Flask to render the python code into the website. Tkinter has also been used in order to make things simpler. It has 2 buttons: Run and Exit. 


Also, in order to keep a proof of the moment when the person was sleeping or yawning, we kept a seperate folder where those frames are stored 
